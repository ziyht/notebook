...
[git](https://github.com/thanos-io/thanos) [指南](https://k8s.imroc.io/monitoring/build-cloud-native-large-scale-distributed-monitoring-system/thanos-arch/)
...
之前在 [大规模场景下 Prometheus 的优化手段](https://k8s.imroc.io/monitoring/build-cloud-native-large-scale-distributed-monitoring-system/optimize-prometheus-in-large-scale.md) 中，我们想尽 “千方百计” 才好不容易把 Prometheus 优化到适配大规模场景，部署和后期维护麻烦且复杂不说，还有很多不完美的地方，并且还无法满足一些更高级的诉求，比如查看时间久远的监控数据，对于一些时间久远不常用的 “冷数据”，最理想的方式就是存到廉价的对象存储中，等需要查询的时候能够自动加载出来。
...
[![img](.assets/readme/thanos-arch.jpg)](https://imroc.io/assets/blog/thanos-arch.jpg)
...
[![img](.assets/readme/thanos-querier.svg)](https://imroc.io/assets/blog/thanos-querier.svg)
...
[![img](.assets/readme/thanos-sidecar.png)](https://imroc.io/assets/blog/thanos-sidecar.png)
...
[![img](.assets/readme/thanos-sidecar-with-objectstore.png)](https://imroc.io/assets/blog/thanos-sidecar-with-objectstore.png)
...
[![img](.assets/readme/thanos-store-gateway.png)](https://imroc.io/assets/blog/thanos-store-gateway.png)
...
[![img](.assets/readme/thanos-ruler.png)](https://imroc.io/assets/blog/thanos-ruler.png)
...
[![img](.assets/readme/thanos-compact.png)](https://imroc.io/assets/blog/thanos-compact.png)
...
[![img](.assets/readme/thanos-receiver.png)](https://imroc.io/assets/blog/thanos-receiver.png)
